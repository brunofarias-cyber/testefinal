...
import { Flame, Calendar, Star, Check, Target, Clock, Trophy } from 'lucide-react';
import { MOCK_MISSIONS } from '../mockDataExtended';

const MissionsSystemComponent = () => {
...
export default MissionsSystemComponent;
